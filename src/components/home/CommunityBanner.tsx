          ...
          <div className="relative m-0.5 rounded-[calc(1.5rem-2px)] bg-zinc-950 p-7 sm:p-9">
            ...
            <div className="relative flex flex-col items-start gap-6 sm:flex-row sm:items-center sm:justify-between">
              ...
              <a
                ...
                className="group inline-flex h-12 shrink-0 items-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-500 px-6 text-sm font-bold text-white shadow-lg shadow-fuchsia-500/30 transition-all hover:-translate-y-0.5 hover:shadow-fuchsia-500/50"
              >
