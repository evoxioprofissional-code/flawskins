  ...
  return (
    <section className="bg-transparent">
      <div className="mx-auto max-w-7xl px-4 pb-12">
        <div className="relative overflow-hidden rounded-3xl shadow-[0_0_70px_-20px] shadow-sky-500/50">
          {/* Borda animada: gradiente cônico girando atrás do card */}
          <div
            aria-hidden
            className="absolute top-1/2 left-1/2 h-[320%] w-[150%] -translate-x-1/2 -translate-y-1/2 animate-[spin_9s_linear_infinite] bg-[conic-gradient(from_0deg,transparent_0deg,#2563eb_60deg,#38bdf8_120deg,transparent_200deg,transparent_360deg)] opacity-80"
          />
          ...
          <div className="relative m-0.5 rounded-[calc(1.5rem-2px)] bg-zinc-950 p-7 sm:p-9">
            ...
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(70%_120%_at_0%_0%,rgba(37,99,235,0.22),transparent_55%)]" />
            ...
            <div className="relative flex flex-col items-start gap-6 sm:flex-row sm:items-center sm:justify-between">
              ...
              <a
                ...
                className="group inline-flex h-12 shrink-0 items-center gap-2 rounded-xl bg-neutral-800 ring-1 ring-white/10 hover:bg-neutral-700 px-6 text-sm font-bold text-blue-300 transition-all hover:-translate-y-0.5"
              >
