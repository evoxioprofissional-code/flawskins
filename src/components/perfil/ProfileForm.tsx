      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="flex items-center gap-4">
          <label className="group relative cursor-pointer">
            <span className="grid size-20 place-items-center overflow-hidden rounded-full bg-gradient-to-br from-blue-500 to-sky-500 text-2xl font-bold text-white">
              {preview ? (
                <Image
                  src={preview}
                  alt="Sua foto"
        ...
        <button
          type="submit"
          disabled={saving}
          className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-neutral-800 ring-1 ring-white/10 hover:bg-neutral-700 px-6 text-sm font-semibold text-blue-300 transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
        >
