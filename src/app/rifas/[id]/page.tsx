...
export async function generateMetadata({ params }: Params): Promise<Metadata> {
  ...
  return { title: rifa ? `${rifa.titulo} — Rifa Cloud Skins` : "Rifa — Cloud Skins" };
}
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-6">
      ...
      <div className="mt-4 grid grid-cols-3 gap-2 text-center">
        <Stat label="Cota" v={formatBRL(rifa.preco_cota)} cor="text-sky-400" />
      ...
      {rifa.status === "finalizada" && rifa.vencedor_numero != null && (
        <div className="mt-5 rounded-2xl border border-blue-500/40 bg-gradient-to-br from-blue-500/15 to-sky-500/10 p-5 text-center">
